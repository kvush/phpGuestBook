 ...
 * Time: 15:16
 */
//TODO: реализовать вывод сообщений со статусом hide.
?>
...
<section class="content-header">
    <h1>
        Все сообщения
        <small>со статусом "hide"</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="/admin"><i class="fa fa-dashboard"></i> Главная</a></li>
        <li class="active">скрытые сообщения</li>
    </ol>
</section>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example2" class="table table-bordered table-hover dataTable" role="grid">
                                    ...
                                    <tbody>
                                    <?php foreach (get_all_messages(false) as $message):?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td><a href="show-msg.php?id=<?=$message['id']?>"><span class="glyphicon glyphicon-eye-open"></span></a></td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
